  ...
  render() {
    return (
      <div className="container my-3">
        <h1 className='text-center'style={{margin:'30px 0px'}}>CGEC-TIMES - Top Headlines...!</h1>
        ...
        <div className="container d-flex justify-content-between">
          ...
          <button disabled={this.state.page + 1 > Math.ceil(this.state.totalResults/this.props.pageSize)} type="button" className="btn btn-dark my-3" onClick={this.handleNextClick}>
            Next &rarr;
          </button>
        </div>
      </div>
